...
export default function ToDoList() {
  ...
  const handleAddTodo = (listIndex) => {
    ...
    if (newTodo !== "") {
      updatedLists[listIndex].todos = [
        ...updatedLists[listIndex].todos,
        { text: newTodo, editing: false },
      ];
  ...
  const handleEditTodo = (listIndex, todoIndex) => {
    ...
    if (
      ...
      inputRefs.current[listIndex][todoIndex]
    ) {
                ...
                <li key={todoIndex}>
                  ...
                  >
                    <input
                      ...
                      onChange={() => {
                        const updatedLists = [...lists];
                        updatedLists[listIndex].todos[todoIndex].checked =
                          !task.checked;
                        setLists(updatedLists);
                      }}
                    />
                    {task.editing ? (
                      <>
                        <input
                          ...
                          onChange={(e) => {
                            const updatedLists = [...lists];
                            updatedLists[listIndex].todos[todoIndex].text =
                              e.target.value;
                            setLists(updatedLists);
                          }}
                          onKeyDown={(e) => {
                  ...
                  <div>
                    ...
                    <button
                      onClick={() => handleEditTodo(listIndex, todoIndex)}
                      type="button"
                    >
                      Edit
                    </button>
